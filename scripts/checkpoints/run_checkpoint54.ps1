...
Write-Host ""
Write-Host "=================================================="
Write-Host "Explain retention model and test stability"
Write-Host "=================================================="

& $Python (
    Join-Path $ProjectRoot "src\analyze_retention_explanations.py"
)

if ($LASTEXITCODE -ne 0) {
    throw "Retention explanation and stability analysis failed."
}
...
if ($LASTEXITCODE -ne 0) {
    throw "Checkpoint 54 automated tests failed."
}

Write-Host ""
Write-Host "=================================================="
Write-Host "CHECKPOINT 54 COMPLETED SUCCESSFULLY"
Write-Host "=================================================="
